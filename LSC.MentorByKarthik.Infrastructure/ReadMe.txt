...
dotnet ef dbcontext scaffold "Server=localhost\SQLEXPRESS01;Initial Catalog=MentorByKarthik;Integrated Security=SSPI; MultipleActiveResultSets=true;TrustServerCertificate=True;" Microsoft.EntityFrameworkCore.SqlServer -o Entities -d
